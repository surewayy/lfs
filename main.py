...
class QuizScreenQ(Screen):
    ...
    {
      "question": "42. From the options lettered A to D, \nchoose the word that cannot be formed\n by an arrangement of some or \nall the letters of the word printed \nin capital letters. INTELLIGENCE",
      "options": ["GENETIC", "CLEANING", "CITIZEN", "GENTLE"],
      "correct_answer": 1
    },
    {
      "question": "43. From the words or group of words lettered \nA to D, choose the one which correctly\n and most suitably fills the \ngap in the sentence. \nWe decided to visit the park ______ the morning.",
      "options": ["in", "on", "at", "by"],
      "correct_answer": 0
    },
    {
      "question": "44. Choose from the list of words lettered A to D,\n the one which is correctly spelt. RESIDENCE",
      "options": ["RESEDENCE", "RECIDENCE", "REZIDENCE", "RESIDANT"],
      "correct_answer": 3
    },
    {
      "question": "45. GENERAL KNOWLEDGE: \nWhat is the currency of Japan?",
